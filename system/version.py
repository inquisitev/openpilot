...
RELEASE_BRANCHES = ['release3-staging', 'release3', 'nightly', 'brightness-options']
TESTED_BRANCHES = RELEASE_BRANCHES + ['devel', 'devel-staging', 'nightly-dev', 'brightness-options']
