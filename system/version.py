...
RELEASE_BRANCHES = ['release3-staging', 'release3', 'nightly',  'distance-button-toggles-exp']
TESTED_BRANCHES = RELEASE_BRANCHES + ['devel', 'devel-staging', 'distance-button-toggles-exp']
