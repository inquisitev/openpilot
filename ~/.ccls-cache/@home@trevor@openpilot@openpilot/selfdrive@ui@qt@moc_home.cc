...
QT_MOC_LITERAL(8, 77, 11), // "showSidebar"
QT_MOC_LITERAL(9, 89, 4), // "show"
QT_MOC_LITERAL(10, 94, 11), // "updateState"
QT_MOC_LITERAL(11, 106, 7), // "UIState"
QT_MOC_LITERAL(12, 114, 1) // "s"

    },
    "HomeWindow\0openSettings\0\0index\0param\0"
    "closeSettings\0offroadTransition\0offroad\0"
    "showSidebar\0show\0updateState\0UIState\0"
    "s"
};
#undef QT_MOC_LITERAL
...
void HomeWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 6: _t->updateState((*reinterpret_cast< const UIState(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
