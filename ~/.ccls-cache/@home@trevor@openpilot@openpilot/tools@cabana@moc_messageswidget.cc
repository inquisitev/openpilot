...
struct qt_meta_stringdata_MessageView_t {
    QByteArrayData data[1];
    char stringdata0[12];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MessageView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MessageView_t qt_meta_stringdata_MessageView = {
    {
QT_MOC_LITERAL(0, 0, 11) // "MessageView"
...
QT_INIT_METAOBJECT const QMetaObject MessageView::staticMetaObject = { {
    QMetaObject::SuperData::link<QTreeView::staticMetaObject>(),
    qt_meta_stringdata_MessageView.data,
    qt_meta_data_MessageView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_MessageView.stringdata0))
        return static_cast<void*>(this);
...
struct qt_meta_stringdata_MessageViewHeader_t {
    QByteArrayData data[1];
    char stringdata0[18];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_MessageViewHeader_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_MessageViewHeader_t qt_meta_stringdata_MessageViewHeader = {
    {
QT_MOC_LITERAL(0, 0, 17) // "MessageViewHeader"
...
static const uint qt_meta_data_MessageViewHeader[] = {
...
void MessageViewHeader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    (void)_o;
    (void)_id;
    (void)_c;
...
QT_INIT_METAOBJECT const QMetaObject MessageViewHeader::staticMetaObject = { {
    QMetaObject::SuperData::link<QHeaderView::staticMetaObject>(),
    qt_meta_stringdata_MessageViewHeader.data,
    qt_meta_data_MessageViewHeader,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
const QMetaObject *MessageViewHeader::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *MessageViewHeader::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_MessageViewHeader.stringdata0))
        return static_cast<void*>(this);
    return QHeaderView::qt_metacast(_clname);
}

int MessageViewHeader::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
QT_MOC_LITERAL(1, 15, 19), // "msgSelectionChanged"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 9), // "MessageId"
QT_MOC_LITERAL(4, 46, 10), // "message_id"
QT_MOC_LITERAL(5, 57, 12), // "titleChanged"
QT_MOC_LITERAL(6, 70, 5) // "title"

    },
    "MessagesWidget\0msgSelectionChanged\0\0"
    "MessageId\0message_id\0titleChanged\0"
    "title"
};
#undef QT_MOC_LITERAL
...
void MessagesWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->msgSelectionChanged((*reinterpret_cast< const MessageId(*)>(_a[1]))); break;
        ...
        {
            using _t = void (MessagesWidget::*)(const MessageId & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessagesWidget::msgSelectionChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MessagesWidget::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MessagesWidget::titleChanged)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void MessagesWidget::msgSelectionChanged(const MessageId & _t1)
{
...
// SIGNAL 1
void MessagesWidget::titleChanged(const QString & _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
